...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: easyrtc_default_event_listeners</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: easyrtc_default_event_listeners</h1>
...
<header>
    <h2>
    easyrtc_default_event_listeners
    </h2>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Event listeners used by EasyRTC. Many of these can be overridden using server options.</div>
...
<dl class="details">
    ...
    <dd class="tag-copyright"><ul class="dummy"><li>Copyright 2014 Priologic Software. All rights reserved.</li></ul></dd>
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="easyrtc_default_event_listeners.js.html">easyrtc_default_event_listeners.js</a>, line 1
    </li></ul></dd>
        ...
        <dl>
            <dt><a href="module-easyrtc_default_event_listeners-eventListener.html">eventListener</a></dt>
            <dd></dd>
        </dl>
