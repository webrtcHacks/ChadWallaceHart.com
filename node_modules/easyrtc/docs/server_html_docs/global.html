...
<dt>
    <h4 class="name" id="appCallback"><span class="type-signature"></span>appCallback<span class="signature">(err, appObj)</span><span class="type-signature"></span></h4>
...
<span class="param-type">Error</span>
            ...
            <td class="description last">Error object. If it is null, than assume no error has occurred.</td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">Application object. Will be null if an error has occurred.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="easyrtc_public_obj.js.html">easyrtc_public_obj.js</a>, line 2814
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="connectionCallback"><span class="type-signature"></span>connectionCallback<span class="signature">(err, connectionObj)</span><span class="type-signature"></span></h4>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">Connection object. Will be null if an error has occurred.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="easyrtc_public_obj.js.html">easyrtc_public_obj.js</a>, line 2817
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="nextCallback"><span class="type-signature"></span>nextCallback<span class="signature">(err)</span><span class="type-signature"></span></h4>
...
<span class="param-type">Error</span>
            ...
            <td class="description last">Optional Error object. If it is null, than assume no error has occurred.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="easyrtc_public_obj.js.html">easyrtc_public_obj.js</a>, line 2811
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="roomCallback"><span class="type-signature"></span>roomCallback<span class="signature">(err, roomObj)</span><span class="type-signature"></span></h4>
...
<span class="param-type">Error</span>
        ...
        <tr>
                ...
                <td class="name"><code>roomObj</code></td>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">Room object. Will be null if an error has occurred.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="easyrtc_public_obj.js.html">easyrtc_public_obj.js</a>, line 2820
    </li></ul></dd>
