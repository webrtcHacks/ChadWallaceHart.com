...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: easyrtc_public_obj</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: easyrtc_public_obj</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Public interface for interacting with EasyRTC. Contains the public object returned by the EasyRTC listen() function.</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="easyrtc_public_obj.js.html">easyrtc_public_obj.js</a>, line 1
    </li></ul></dd>
        ...
        <dl>
            <dt><a href="module-easyrtc_public_obj-pub.html">pub</a></dt>
            <dd></dd>
        </dl>
